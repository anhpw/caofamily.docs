...
const config = {
  ...
  organizationName: 'anhpw', // Usually your GitHub org/user name.
  projectName: 'caofamily.docs', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/anhpw/caofamily.docs/edit/master/',
        },
        blog: false,
        theme: {
    ...
    ({
      navbar: {
        ...
        items: [
          ...
          // },
          // {
          //   href: 'https://github.com/anhpw/caofamily.docs',
          //   label: 'GitHub',
          //   position: 'right',
          // },
        ],
